...
def world_sales_analytics():

    st.title("International Sales Analytics")
    ...
    with st.container():
        ...
        map = display_world_map(sales_queried, "<b>Sales per Country($)</b>", map_lat, map_long, map_color, sales_queried.index)
    ...
    st.markdown(
        """
        <style>
        .css-1idizjf, .css-zi8otl, .css-16i25t9, .css-18ut3yg, .css-j5r0tf{
            border: 1px solid;
            text-align: center;
        }
        </style>
